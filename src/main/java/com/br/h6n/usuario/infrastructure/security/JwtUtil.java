...
public class JwtUtil {
    ...
    public String generateToken(String username) {
        return Jwts.builder()
                ...
                .setExpiration(new Date(System.currentTimeMillis() + 1000 * 60 * 60)) // Define a data e hora de
                                                                                      // expiração (1 hora a partir da
                                                                                      // emissão)
                .signWith(Keys.hmacShaKeyFor(secretKey.getBytes(StandardCharsets.UTF_8)), SignatureAlgorithm.HS256) // Converte
                                                                                                                    // a
                                                                                                                    // chave
                                                                                                                    // secreta
                                                                                                                    // em
    ...
    public boolean validateToken(String token, String username) {
        ...
        // Verifica se o nome de usuário do token corresponde ao fornecido e se o token
        // não está expirado
